...
const checkForUpdates = ref(settingContent.value.setting.checkForUpdates ?? false)

const handleCheckForUpdates = (data: boolean) => {
    checkForUpdates.value = data
}
...
const initDate = async() => {
    ...
    checkForUpdates.value = settingContent.value.setting.checkForUpdates ?? false
}
        ...
        <div class="setting-main">
            ...
            <div class="item">
                ...
                <div class="option">
                    ...
                    <label>
                        <div>
                            <svg class="option-icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm193.5 301.7l-210.6 292a31.8 31.8 0 0 1-51.7 0L318.5 484.9c-3.8-5.3 0-12.7 6.5-12.7h118.4c6.3 0 10.8-6.1 8.5-12L409 360.5c-3.9-5.4.3-12.8 6.6-12.8h142.3c6.4 0 10.6 6.4 6.8 12.3L706.5 353c3.9-5.3.1-12.7-6.4-12.7h-46.1c-10.2 0-19.9-4.9-25.9-13.2L512 158.6 406.4 327.1c-6 8.3-15.6 13.2-25.9 13.2H334c-6.5 0-10.3 7.4-6.5 12.7l126.4 174a16.3 16.3 0 0 1-13.2 25.7H316c-6.5 0-10.3 7.4-6.5 12.7l131.7 180.6z"
                                />
                            </svg>
                            检查应用更新
                        </div>
                        <Button :theme="checkForUpdates" @update="handleCheckForUpdates">
                            <template #label1>关</template>
                            <template #label2>开</template>
                        </Button>
                    </label>
